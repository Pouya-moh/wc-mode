...
;;
;; Version 0.2
;; * Fix bug in character count for narrowed buffers.
;;
;; Version 0.2
...
(provide 'wc-doom-mode)


;; add length display to mode-line construct
; (setq mode-line-position (assq-delete-all 'wc-doom-mode mode-line-position))
...
(define-minor-mode wc-doom-mode
  "Toggle word-count mode.
With no argument, this command toggles the mode.
A non-null prefix argument turns the mode on.
A null prefix argument turns it off. This version
is tailored to work with doom-modeline.

When enabled, the total number of characters, words, and lines is
displayed in the mode-line.")


;;; wc-doom-mode.el ends here
